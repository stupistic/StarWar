...
if(props.detail ===undefined ){
  ...
  return <div className='container-fluid c3  text-center'>
       <h1 className='c1'>Planet Info</h1>
        ...
        <div className=' col e1'><span className='float-left'><i className="fa fa-globe d1 d100"/></span>Planet Name</div>
        ...
        <h1 className='c2 float-left row'>
        <div className=' col  e1'><span className='float-left'><i className="fa fa-circle d1 d102"/></span> Diameter</div>
         < div className='c4 col shadow '>{props.detail.diameter}</div>
        </h1>

        <h1 className='c2  float-left row'>
        <div className=' col  e1'><span className='float-left'><i className="fab fa-grav d1 d103"/> </span>Gravity </div>
        ...
        <h1 className='c2  float-left row'>
        <div className='  col  e1'><span className='float-left'><i className="fa fa-water d1 d105"/> </span>Surface water</div>
